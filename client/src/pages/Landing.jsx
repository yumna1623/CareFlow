      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto py-12 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left py-12">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold mb-4 text-gray-900 leading-none">
               YOUR HOSPITAL, <br />
              YOUR DOCTOR.
            </h1>
            ...
            <p className="text-lg mb-8 text-gray-600 max-w-md">
              Care Flow Hospital, your health is our priority. With a dedicated
              team of experts and comprehensive medical services, we are
          ...
          <div className="relative h-full min-h-[500px] flex flex-col justify-between items-end">
            ...
            <div className="absolute top-0 right-0">
              <StatBox value="+180" label="Servicii medicale" />
            </div>
 ...
 */}
            ...
            <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2">
              <SpecialtyBox count="12" label="Specialități medicale" />
            </div>
